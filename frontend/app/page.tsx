        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-6xl lg:text-8xl font-black leading-none mb-6">
              The <span className="text-blue-500">Autonomous</span><br/>Commerce.
            </h1>
            <p className="text-xl text-muted-foreground mb-10 max-w-lg">
              Experience the next generation of shopping powered by intelligent agents. Secure, lightning-fast, and proactive.
            </p>
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="aspect-square rounded-3xl bg-blue-500/10 border border-blue-500/20 overflow-hidden glassmorphism flex items-center justify-center p-12">
               <div className="w-full h-full rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-800 shadow-2xl flex items-center justify-center">
